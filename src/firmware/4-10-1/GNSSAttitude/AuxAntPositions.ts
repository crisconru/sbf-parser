import { DOUBLE, UINT8 } from "../../../shared/constants"
...
// AuxAntPositions
const N_INDEX = 0
const N_LENGTH = UINT8

const SBLENGTH_INDEX = N_INDEX + N_LENGTH
const SBLENGTH_LENGTH = UINT8
// AuxAntPositionSub
const NRSV_INDEX = 0
